...
//
//import com.imooc.mybatis.mapper.CwxxTxlMapper;
...
//
///**
// * Created by ljq on 2023/3/11.
// */
//@Service
//public class cwxxtxlService {
//
//    @Autowired
//    private CwxxTxlMapper TxlMapper;
//
//
//    public Object dcTxlMsg(String dwId) {
//        //定义返还值为空，进行判断
//        String msg = "";
//        //获取当前单位下所有的单位信息
//        Cwxx_wldw wldwToId = TxlMapper.getWldwToId(dwId);
//        //获取当前单位下所有的通讯录信息
//        List<Cwxx_txl> userMsgs = TxlMapper.getUserMsg(dwId);
//        //循环判断找出处长及以上的用户唯一id
//        List<String> userIds = TxlMapper.selectIdList(dwId);
//        //判断id列是否与处长列id相同
//        //处长及以上列
//        List<Cwxx_txl> CZuserMsgs = new ArrayList<>();
//        //非处长及以上
//        List<Cwxx_txl> NoCZuserMsgs = new ArrayList<>();
//        try{
//            if(userMsgs.size()> 0) {
//                if (userIds.size() > 0) {
//                    //循环遍历获取到两个list集合
//                    for (Cwxx_txl userMsg : userMsgs) {
//                        if (userMsg.getF_id() != null) {
//                            for(String userId:userIds){
//                                if( userId.equals(userMsg.getF_id())){
//                                    //处长以上
//                                    CZuserMsgs.add(userMsg);
//                                }else{
//                                    //非处长以上
//                                    NoCZuserMsgs.add(userMsg);
//                                }
//
//                            }
//                        }
...
//                        getValue(wldwToId,CZuserMsgs,NoCZuserMsgs,fout);
//                        fout.close();
//                    }
//                    catch (Exception e)
//                    {
...
//
//
//    public void getValue(Cwxx_wldw wldwToId,List<Cwxx_txl> CZuserMsgs,List<Cwxx_txl> NoCZuserMsgs, FileOutputStream fout){
//        try{
//            //创建工作簿
...
//            //行1 电话区号  值
//            CellRangeAddress callRangeAddress2 = new CellRangeAddress(1,1,2,2);//起始行,结束行,起始列,结束列
//            //行1 经理办电话
//            CellRangeAddress callRangeAddress3 = new CellRangeAddress(1,1,3,4);//起始行,结束行,起始列,结束列
//            //行1 经理办电话 值
//            CellRangeAddress callRangeAddress4 = new CellRangeAddress(1,1,5,6);//起始行,结束行,起始列,结束列
//            //行1 财务处传真
//            CellRangeAddress callRangeAddress5 = new CellRangeAddress(1,1,7,7);//起始行,结束行,起始列,结束列
//            //行1 财务处传真 值
//            CellRangeAddress callRangeAddress6 = new CellRangeAddress(1,1,8,9);//起始行,结束行,起始列,结束列
//            //行2 通讯地址
//            CellRangeAddress callRangeAddress7 = new CellRangeAddress(2,2,0,1);//起始行,结束行,起始列,结束列
//            //行2 通讯地址 值
//            CellRangeAddress callRangeAddress8 = new CellRangeAddress(2,2,2,7);//起始行,结束行,起始列,结束列
//            //行2 邮编
//            CellRangeAddress callRangeAddress9 = new CellRangeAddress(2,2,8,8);//起始行,结束行,起始列,结束列
//            //行2 邮编
//            CellRangeAddress callRangeAddress10 = new CellRangeAddress(2,2,9,9);//起始行,结束行,起始列,结束列
//
//
//            //带照片的用户
//            //行3  序号
//            CellRangeAddress callRangeAddress11 = new CellRangeAddress(3,6,0,0);//起始行,结束行,起始列,结束列
//            //行3  照片
//            CellRangeAddress callRangeAddress12 = new CellRangeAddress(3,6,1,2);//起始行,结束行,起始列,结束列
//            //行3  姓名
//            CellRangeAddress callRangeAddress13 = new CellRangeAddress(3,3,3,4);//起始行,结束行,起始列,结束列
//            //行3  姓名 值
//            CellRangeAddress callRangeAddress14 = new CellRangeAddress(3,3,5,6);//起始行,结束行,起始列,结束列
//            //行3  职务
//            CellRangeAddress callRangeAddress15 = new CellRangeAddress(3,3,7,7);//起始行,结束行,起始列,结束列
//            //行3  职务 值
//            CellRangeAddress callRangeAddress16 = new CellRangeAddress(3,3,8,9);//起始行,结束行,起始列,结束列
//
//            //行4  科室名称
//            CellRangeAddress callRangeAddress17 = new CellRangeAddress(4,4,3,4);//起始行,结束行,起始列,结束列
//            //行4  科室名称 值
//            CellRangeAddress callRangeAddress18 = new CellRangeAddress(4,4,5,6);//起始行,结束行,起始列,结束列
//            //行4  办公电话
//            CellRangeAddress callRangeAddress19 = new CellRangeAddress(4,4,7,7);//起始行,结束行,起始列,结束列
//            //行4  办公电话 值
//            CellRangeAddress callRangeAddress20 = new CellRangeAddress(4,4,8,9);//起始行,结束行,起始列,结束列
//
//
//
//            //行5  移动电话
//            CellRangeAddress callRangeAddress21 = new CellRangeAddress(5,5,3,4);//起始行,结束行,起始列,结束列
//            //行5  移动电话 值
//            CellRangeAddress callRangeAddress22 = new CellRangeAddress(5,5,5,6);//起始行,结束行,起始列,结束列
//            //行5  邮箱
//            CellRangeAddress callRangeAddress23 = new CellRangeAddress(5,5,7,7);//起始行,结束行,起始列,结束列
//            //行5  邮箱 值
//            CellRangeAddress callRangeAddress24 = new CellRangeAddress(5,5,8,9);//起始行,结束行,起始列,结束列
//
//
//
//            //行6  主管业务
//            CellRangeAddress callRangeAddress25 = new CellRangeAddress(6,6,3,4);//起始行,结束行,起始列,结束列
//            //行6  主管业务 值
//            CellRangeAddress callRangeAddress26 = new CellRangeAddress(6,6,5,9);//起始行,结束行,起始列,结束列
//
//            //行序号
//
//
...
//
//            //金额
//            CellRangeAddress callRangeAddressnumber1 = new CellRangeAddress(CZuserMsgs.size()+5,CZuserMsgs.size()+5,0,2);//起始行,结束行,起始列,结束列
//            CellRangeAddress callRangeAddressnumber2 = new CellRangeAddress(CZuserMsgs.size()+5,CZuserMsgs.size()+5,3,7);//起始行,结束行,起始列,结束列
//
////            //负责人
...
//            HSSFCellStyle styleCon = workbook.createCellStyle();
...
//            String idPath = "123.jpg";
//
//            //图片路径
//            String imagePath = "D:/cwxxwImg/" + idPath;
